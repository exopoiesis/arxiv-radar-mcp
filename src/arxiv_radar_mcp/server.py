...
TOOL_SPECS: list[dict[str, Any]] = [
    ...
    # ----- async admin (5 tools) ------------------------------------------
    {
        ...
        "description": (
            ...
            "Handles PDF-only papers too -- use it for ANY arxiv_id. Sources "
            "are tried in order: (1) arxiv.org/html, (2) arxiv.org/e-print "
            "(LaTeX), (3) arxiv.org/pdf parsed by MinerU for the ~10-25% of "
            "papers that have no HTML/LaTeX source. The PDF tier needs the "
            "arxiv-radar-mcp[pdf] extra installed; without it, PDF-only papers "
            "report a clear 'install [pdf]' error while HTML/LaTeX papers still "
            "work. Papers that fail all applicable tiers report a clear error. "
