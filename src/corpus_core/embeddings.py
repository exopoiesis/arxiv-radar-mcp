...
if TYPE_CHECKING:
    ...
    # target_dim}` — i.e. a downstream project's Config. Imported here for
    # type hints only so corpus_core stays runtime-independent of any
    # specific project schema.
    from arxiv_radar_mcp.config import Config  # noqa: F401
